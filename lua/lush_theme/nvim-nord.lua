...
local theme = lush(function()
  return {
    ...
    LspDiagnosticsFloatingError          { fg = clrs.nord11, bg = clrs.nord0 }, -- Used to color "Error" diagnostic messages in diagnostics float
    LspDiagnosticsFloatingWarning        { fg = clrs.nord13, bg = clrs.nord0 }, -- Used to color "Warning" diagnostic messages in diagnostics float
